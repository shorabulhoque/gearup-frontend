...
import { createGear } from "@/services/gear/gear.actions";

export default function CreateGearPage() {
    const handleCreate = async (data: GearFormData) => {
        return await createGear({
            ...data,
    ...
    return <GearForm onSubmit={handleCreate} isEditMode={false} />;
}
// "use client";
...
//             router.push("/dashboard/manage-gears");
//         } else {
